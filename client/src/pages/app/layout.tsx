...
import { Mic, Folder, LayoutDashboard, Settings, LogOut, Menu, X, MessageSquarePlus } from 'lucide-react'
    ...
    <div className="min-h-svh lg:h-svh bg-background flex flex-col lg:flex-row">
      ...
      <aside className={cn(
        ...
        <div className="p-4 border-b border-border shrink-0">
          <h1 className="text-lg font-bold hidden lg:block leading-tight">Transcriber, I Hardly Knew Her</h1>
        ...
        <div className="p-4 border-t border-border space-y-3 shrink-0">
          ...
          <div className="flex items-center gap-1 p-0.5 bg-accent/50 rounded-md">
            <button
              ...
              className={cn(
                'flex-1 p-1.5 rounded transition flex items-center justify-center',
                mode === 'light'
          ...
          <div className="space-y-1">
            <NavLink to="/feedback" icon={<MessageSquarePlus size={20} />}>
              Feedback
            </NavLink>
