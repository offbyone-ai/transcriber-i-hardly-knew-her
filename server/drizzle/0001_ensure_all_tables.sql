-- Migration to ensure all tables exist (fixes partial migrations from old system)
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_usage_userId_month` ON `server_transcription_usage` (`userId`,`monthYear`);
